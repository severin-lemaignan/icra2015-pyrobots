...
\end{tabular}
\end{center}
\caption{Examples of \pyRobots actions, mostly stemming from experiments involving
    the PR2 robot.}
...
\paragraph{Roboscopie} The first complex deployment scenario for \pyRobots was indeed a theatre
performance entitled \emph{Roboscopie}~\cite{lemaignan2012roboscopie}. The
toolkit was created out of the need to control a complex robot (a Willow Garage
PR2) in a structured way, as required for a live performance with a
...
\begin{figure}
        ...
        \caption{Children teaching An Aldebaran Nao interacting with }
        \label{expe-cowriter}
\end{figure}
